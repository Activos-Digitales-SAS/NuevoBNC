...
const FormJuridicos = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const uploadResponse = await axios.post('https://bnc-group.onrender.com/upload-juridicos', formData, {
                headers: {
    ...
    const handleModalSubmit = async () => {
        if (Object.values(acceptPolicies).every(Boolean)) {
            ...
            try {
                const saveResponse = await axios.post('https://bnc-group.onrender.com/save-juridicos', finalData);
    ...
    const translations = {
        es: {
            title: 'KyC - Vinculación PERSONA JURIDICA - BNC GROUP. PSAV',
        ...
        en: {
            title: 'KyC - LEGAL PERSON Linkage - BNC GROUP. PSAV',
...
<form onSubmit={handleSubmit} className={styles.containerPersonas}>
    ...
    <p>{language === 'es' ? 'De conformidad con lo dispuesto en la Ley 1581 de 2012 y el Decreto 1377 de 2013, se desarrolla el principio constitucional que tienen todas las personas a conocer, actualizar, rectificar o suprimir la información que haya sido recolectada, almacenada y usada o que haya sido objeto de tratamiento de datos personales en bancos, en bases de datos y en general en archivos de entidades públicas y privadas. BNC GROUP, solicita a sus clientes, proveedores, afiliados, terceras partes involucradas, autorización para que de manera libre, previa, expresa, voluntaria e informada permita recolectar, almacenar, usar, suprimir, actualizar, procesar, recopilar, intercambiar, dar tratamiento y disponer de los datos que han sido suministrados y que se han incorporado en distintas bases de datos de la compañía. Los datos personales serán utilizados con propósito de llevar a cabo comunicaciones por call center, sistema de llamada automática de voz, mensajes de texto, correo electrónico, medios audiovisuales, tales como carteleras, fax, telegrama, correo certificado, página web, o cualquier otro dispositivo que llegue a estar disponible. Igualmente, dichas comunicaciones podrán ser con fines de verificación de datos, cobro de cartera, información sobre nuestros servicios, ofertas, promociones, eventos, realización de actividades de fidelización, encuestas para identificarlo y en general para que exista una comunicación más eficiente. Según las políticas de tratamiento de datos personales, los mecanismos a través de los cuales hacemos uso de sus datos personales son seguros y confiables, pues contamos con medios tecnológicos idóneos que garantizan su confidencialidad. Como titular de sus datos personales, usted tiene la facultad de ejercer los derechos que asisten, tales como conocer, actualizar, rectificar o suprimir sus datos personales. En los términos dispuestos por el Artículo 10 del Decreto 1377 de 2013, queda autorizada de manera expresa e inequívoca para mantener y manejar toda su información, a no ser que usted manifieste lo contrario de manera directa, expresa, inequívoca y por escrito dentro de los treinta (30) días hábiles contados a partir de la publicación o recepción de la presente comunicación a la cuenta de correo electrónico dispuesta para tal efecto: bncgroupsas@gmail.com. En el evento en que usted considere que BNC GROUP, dio un uso contrario a lo autorizado y a las leyes aplicables, podrá contactarnos a través de una comunicación motivada dirigida al correo: bncgroupsas@gmail.com' : 'In accordance with the provisions of Law 1581 of 2012 and Decree 1377 of 2013, the constitutional principle that all individuals have the right to know, update, rectify, or delete the information that has been collected, stored, and used, or that has been subject to the processing of personal data in banks, databases, and generally in files of public and private entities is developed. BNC GROUP requests authorization from its clients, suppliers, affiliates, and third parties involved to freely, priorly, expressly, voluntarily, and informatively allow the collection, storage, use, deletion, updating, processing, collection, exchange, treatment, and disposal of the data that have been provided and incorporated into various company databases. Personal data will be used for the purpose of carrying out communications through call centers, automatic voice call systems, text messages, email, audiovisual media such as bulletin boards, fax, telegram, certified mail, web page, or any other device that becomes available. These communications may also be for the purposes of data verification, portfolio collection, information about our services, offers, promotions, events, loyalty activities, surveys to identify you, and generally to ensure more efficient communication. According to personal data processing policies, the mechanisms through which we use your personal data are secure and reliable, as we have suitable technological means that ensure its confidentiality. As the owner of your personal data, you have the right to exercise rights such as knowing, updating, rectifying, or deleting your personal data. Under the terms provided by Article 10 of Decree 1377 of 2013, it is expressly and unequivocally authorized to maintain and manage all your information, unless you expressly and unequivocally state otherwise in writing within thirty (30) business days from the publication or receipt of this communication to the email account provided for this purpose: bncgroupsas@gmail.com. In the event that you consider that BNC GROUP has made unauthorized use of your data contrary to applicable laws, you can contact us through a motivated communication addressed to the email: bncgroupsas@gmail.com.'}</p>
    ...
    <p>{language === 'es' ? 'EL PROVEEDOR y/o CLIENTE se obliga a cumplir con la política de prevención y control del riesgo de lavado de activos y financiación del terrorismo adoptada por BNC GROUP, así como las normas y estándares internacionales que regulan la materia. En caso de tener conocimiento de una operación intentada o sospechosa, BNC GROUP lo reportará de forma inmediata a la UIAF (Unidad de Información y Análisis Financiero) y dará por terminada la relación contractual entre las partes, sin que haya lugar al pago de ninguna indemnización a favor de EL PROVEEDOR y/o CLIENTE.' : 'The PROVIDER and/or CLIENT is obligated to comply with the policy of prevention and control of money laundering and terrorist financing risk adopted by BNC GROUP, as well as the international regulations and standards governing the matter. In the event of becoming aware of an attempted or suspicious operation, BNC GROUP will immediately report it to the UIAF (Financial Information and Analysis Unit) and will terminate the contractual relationship between the parties without any compensation being payable to the PROVIDER and/or CLIENT.'}</p>
