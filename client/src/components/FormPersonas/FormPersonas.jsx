...
const FormPersonas = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const uploadResponse = await axios.post('https://bnc-group.onrender.com/upload-personas', formData, {
                headers: {
    ...
    const handleModalSubmit = async () => {
        if (Object.values(acceptPolicies).every(Boolean)) {
            ...
            try {
                const saveResponse = await axios.post('https://bnc-group.onrender.com/save-personas', finalData);
    ...
    const translations = {
        es: {
            title: 'KyC - Vinculación PERSONA NATURAL - BNC GROUP. PSAV',
        ...
        en: {
            title: 'KyC - NATURAL PERSON Linkage - BNC GROUP. PSAV',
